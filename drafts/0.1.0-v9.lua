...
-- Custom Draggable Border Frame (Encompasses boundaries safely)
local borderDragFrame = Instance.new("Frame")
borderDragFrame.Name = "BorderDragFrame"
borderDragFrame.Size = UDim2.new(1, 10, 1, 10)
borderDragFrame.Position = UDim2.new(0, -5, 0, -5)
borderDragFrame.BackgroundTransparency = 1
borderDragFrame.ZIndex = 10 -- Layer over borders for easy dragging access
borderDragFrame.Draggable = true
borderDragFrame.Active = true
borderDragFrame.Parent = mainUIFrame

-- Drag synchronization handler 
borderDragFrame:GetPropertyChangedSignal("Position"):Connect(function()
    mainUIFrame.Position = mainUIFrame.Position + borderDragFrame.Position - UDim2.new(0, -5, 0, -5)
    borderDragFrame.Position = UDim2.new(0, -5, 0, -5)
end)
