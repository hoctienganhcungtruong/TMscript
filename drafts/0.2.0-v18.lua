...
-- SỬA LỖI SLIDER: Đồng bộ callback thay đổi giá trị trực tiếp vào Slider
...
-- HÀM TÌM NGƯỜI CHƠI GẦN TÂM CHUỘT NHẤT ĐƯỢC CHỌN (ĐÃ BỔ SUNG)
    ...
    if circleEnabled then
        ...
        if targetPart then
            ...
            if mouseDelta.Magnitude > 0.1 then
                -- Tay vẩy chuột tự do hoàn toàn, triệt tiêu lực ghì cản của hack
                ...
                -- Tự động hút tâm về khi tay ngừng flick chuột
